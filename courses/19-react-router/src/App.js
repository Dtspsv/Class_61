...
const Page3 = (props) => {
    ...
    console.log('page 3 params', page3Params)
    const {name} = page3Params

    console.log('props of page 3', props)
...
const NavBar = () => {
    ...
    return (
        <nav style={{width: 500, display: 'flex', justifyContent: 'space-between'}}>
            ...
            <Link to={`/product/${name123}`}> Page 3</Link>
    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/product/:name" element={<Page3 singerId={'789'} prop2={'bbb'}/>}/>
